...
/* custom Pilot Flags */
#define __IEC_SUBSCRIBE_FLAG 0x10
#define __IEC_DIRTY_FLAG 0x20
#define __IEC_UPDATE_MISSED_FLAG 0x40
...
\
typedef struct {\
  volatile IEC_##type* value;\
  IEC_##type changed;\
  IEC_##type* pchanged;\
  IEC_BYTE flags;\
  IEC_BYTE* pflags;\
  IEC_##type fvalue;\
  unsigned long long last_write_tick;\
} __IEC_##type##_p;
